...
class _DrawingScreenState extends State<DrawingScreen> {
  ...
  static const String _progressKey = 'drawingScreenProgress';
  static const String _scoreKey = 'drawingScreenScore';
  static const String _completedLettersKey = 'drawingScreenCompletedLetters';
      ...
      if (_currentLetterIndex < _labels.length - 1) {
        ...
        showDialog(
          ...
          builder: (context) => AlertDialog(
            ...
            content: const Text('لقد أكملت جميع الحروف بنجاح!'),
            actions: [
              TextButton(
                onPressed: () {
